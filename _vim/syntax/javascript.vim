...
syntax keyword javaScriptOperator       delete new in instanceof let typeof indexOf lastIndexOf alert
syntax keyword javaScriptBoolean        true false
syntax keyword javaScriptNull           null

"" Statement Keywords
syntax keyword javaScriptConditional    if else
syntax keyword javaScriptRepeat         do while for forEach every filter map some
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javaScriptYUIPrivate           String
